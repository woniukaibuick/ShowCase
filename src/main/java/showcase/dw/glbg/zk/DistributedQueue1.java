 ...
 * 
 */
public class DistributedQueue1 {
    private static final Logger LOG = LoggerFactory.getLogger(MyDistributedQueue.class);
    ...
    public DistributedQueue1(ZooKeeper zookeeper, String dir, List<ACL> acl){
        this.dir = dir;
